                ...
                <div className='flex py-16'>
                    ...
                    <div className='form grow'>
                        ...
                        <Form name="form_item_path" layout="vertical" onFinish={onFinish}>
                            ...
                            <label htmlFor="name">
                                <p>{t?.name}</p>
                                <Input value={userData?.first_name} className='mb-4 rounded-lg p-4 bg-slate-100 border-none outline-none' placeholder={t?.name} />
                            </label>

                            <label htmlFor="lastname">
                                <p>{t?.surname}</p>
                                <Input value={userData?.last_name} className='mb-4 rounded-lg p-4 bg-slate-100 border-none outline-none' placeholder={t?.surname} />
                            </label>
                            ...
                            <div className='flex gap-x-4 w-full'>
                                <label htmlFor="tel" className='grow'>
                                    <p>{t?.tel}:</p>
                                    <Input value={userData?.phone} type="tel" className='mb-4 rounded-lg p-4 bg-slate-100 border-none outline-none' placeholder={t?.tel} />
                                </label>
