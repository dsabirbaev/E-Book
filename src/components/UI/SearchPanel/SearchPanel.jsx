    ...
    return (
        <section>
            <div className='w-[80%] rounded-[15px] bg-white py-[47px] px-[144px] border mx-auto -mt-12 relative z-40'>
                <h2 className='text-center text-[#C9AC8C] text-[31px] font-["Rotter"] mb-[13px] text-[#C9AC8C]'>{t("search")}</h2>
                <div className="flex gap-x-[14px]">
                    <TextInput className="grow" placeholder={t("searchPlaceholder")} />
                    <Button className="bg-[#C9AC8C] text-white flex items-center justify-center">
                        ...
                        <span className="ms-[5px]">{t("search")}</span>
